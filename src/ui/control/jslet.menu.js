        ...
        jqMi.on('click',function (event) {
            ...
            if(!cfg.items) {
                if (cfg.onClick) {
                    ...
                    if (Z.onItemClick)
                        Z.onItemClick.call(Z, cfg.id || cfg.name);
                }
...
jslet.ui.Menu = jslet.Class.create(jslet.ui.Control, {
    ...
    _ItemClick: function (sender, cfg) {
        ...
        if (cfg.onClick) {
            ...
            if (this.onItemClick) {
                this.onItemClick.call(contextObj, cfg.id || cfg.name, cfg.checked);
            }
        }
